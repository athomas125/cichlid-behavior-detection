...
def make_dlc_model(cfg, feature_dim, kpt_num, feature_extractor=None, feature_extractor_in_dim=0, feature_extractor_out_dim=0):
    if feature_extractor is None:
        model = build_dlc_transformer(cfg, feature_dim, kpt_num, __factory_T_type)
    else:
        model = build_dlc_transformer_w_feat_extractor(cfg,
                                                    feature_dim,
                                                    kpt_num,
                                                    __factory_T_type,
                                                    feature_extractor,
